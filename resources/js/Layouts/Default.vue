            ...
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <div v-if="user.role === 'client'" class="space-y-2">
                        ...
                        <li>
                            <Link :href="route('clients.vehicles.index', user.client)" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
