        ...
        <div class="flex items-center justify-center h-screen">
            <div class="w-full max-w-md">
                <div class="mb-4 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Ingresa tus credenciales a continuación</p>
                </div>
                ...
                <form class="max-w-sm mx-auto" @submit.prevent="form.post(route('login'))">
                    ...
                    <Transition name="fade">
                        <div v-if="form.errors?.login" class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                            <span class="font-medium">No fue posible iniciar sesión</span>, {{ form.errors.login }}
                        </div>
                    </Transition>
                    ...
                    <div class="mb-5">
                        ...
                        <Link :href="route('register')" class="text-blue-600 text-sm hover:underline dark:text-blue-500">No tengo cuenta, deseo registrarme</Link>
                    </div>
